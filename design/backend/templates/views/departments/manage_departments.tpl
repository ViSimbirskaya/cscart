    ...
    {capture name="departments_table"}
        <div class="table-responsive-wrapper longtap-selection">
            ...
            >
                ...
                <td width="6%">
                  <input type="text" name="departments_data[{$department.department_id}]][is_status]" value="{$department.is_status}" size="2" class="input-micro input-hidden">
                </td>
                ...
                <td width="15%" class="mobile-hide">
                    {capture name="tools_list"}
                        <li>{btn type="list" text=__("edit") href="departments.update_department"}</li>
                    {if $allow_save}
...
{capture name="adv_buttons"}
    {include file="common/tools.tpl" tool_href="departments.add_department" prefix="top" hide_tools="true" title=("Create new department") icon="icon-plus"}
{/capture}
