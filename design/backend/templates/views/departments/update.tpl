...
{capture name="mainbox"}
    ...
    <form action="{""|fn_url}" method="post" enctype="multipart/form-data" class="form-horizontal form-editedit" name="departments_update_form">
        ...
        <input type="hidden" name="department_id" value="{$id}" />
            ...
            <div id="content_general">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="department_data[name]" id="elm_department_name" value="{$department.name}" size="25" class="input-large" />
                    </div>
                </div>
...
{capture name="buttons"}
    {include file="buttons/save.tpl" but_name="dispatch[departments.update]" but_target_form="departments_update_form" but_role="submit-link" save=$id}
{/capture}

{include file="common/mainbox.tpl"
    sidebar=$smarty.capture.sidebar
    sidebar_position="left"
    title=($id) ? $department_data.title : __("new_department")
