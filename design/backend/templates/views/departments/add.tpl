...
<input type="hidden" class="cm-no-hide-input" name="department_id" value="{$id}" />
    ...
    <div id="content_general">
        ...
        {include file="common/select_status.tpl" input_name="department_data[status]" id="elm_department_status" obj_id=$id obj=$department hidden=false}
    <!--content_general--></div>
...
{capture name="buttons"}
        {include file="buttons/save_cancel.tpl" but_role="submit-link" but_target_form="departments_add_form" but_name="dispatch[departments.update]"}
{/capture}
...
{include file="common/mainbox.tpl"
    title=($id) ? $department.department : ("Create new department")
