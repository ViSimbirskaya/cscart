<?php
/* Smarty version 4.1.0, created on 2022-07-18 19:51:19
  from 'C:\OpenServer\domains\cscart\design\backend\templates\views\block_manager\manage.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62d58f87dca0c6_27401109',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1b4c419590c115b12fcf44545f03d6094cbbdf16' => 
    array (
...
function content_62d58f87dca0c6_27401109 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\function.script.php','function'=>'smarty_function_script',),1=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\block.inline_script.php','function'=>'smarty_block_inline_script',),2=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\function.style.php','function'=>'smarty_function_style',),3=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\block.hook.php','function'=>'smarty_block_hook',),4=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\function.render_location.php','function'=>'smarty_function_render_location',),));
...
$_smarty_tpl->_assignInScope('m_url', rawurlencode($_REQUEST['manage_url']));
...
echo '<script'; ?>
 class="cm-ajax-force">
    var selected_location = '<?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['location']->value['location_id'] ?? null)===null||$tmp==='' ? 0 ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
';

    var dynamic_object_id = '<?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['dynamic_object']->value['object_id'] ?? null)===null||$tmp==='' ? 0 ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
';
    var dynamic_object_type = '<?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['dynamic_object_scheme']->value['object_type'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
';
...
'
    ...
    var editObjectId = <?php echo htmlspecialchars(strtr((($tmp = $_smarty_tpl->tpl_vars['edit_object_id']->value ?? null)===null||$tmp==='' ? 0 ?? null : $tmp), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" )), ENT_QUOTES, 'UTF-8');?>
,
        editObjectType = '<?php echo htmlspecialchars(strtr((($tmp = $_smarty_tpl->tpl_vars['edit_object_type']->value ?? null)===null||$tmp==='' ? '' ?? null : $tmp), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" )), ENT_QUOTES, 'UTF-8');?>
';
...
?>
                <?php $_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
                <?php $_smarty_tpl->_subTemplateRender("tygh:common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('id'=>"upate_layout_".((string)$_smarty_tpl->tpl_vars['layout_data']->value['layout_id']),'text'=>$_smarty_tpl->tpl_vars['layout_data']->value['name'],'content'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'add_new_picker'),'act'=>"link",'link_text'=>$_smarty_tpl->__("properties")), 0, true);
?>
            </li>
            <li class="divider"></li>
            <?php if (!$_smarty_tpl->tpl_vars['layouts']->value[$_smarty_tpl->tpl_vars['layout_data']->value['layout_id']]['is_default']) {?>
...
?>
                                        <?php $_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
                                        <?php $_smarty_tpl->_subTemplateRender("tygh:common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('id'=>"upate_layout_".((string)$_smarty_tpl->tpl_vars['layout']->value['layout_id']),'text'=>$_smarty_tpl->tpl_vars['layout']->value['name'],'content'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'add_new_picker'),'act'=>"link",'link_text'=>$_smarty_tpl->__("properties")), 0, true);
?>
                                    </li>
