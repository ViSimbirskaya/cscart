...
/* Smarty version 4.1.0, created on 2022-07-15 17:11:23
  from 'C:\OpenServer\domains\cscart\design\backend\templates\addons\price_per_unit\hooks\products\update_product_availability.pre.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62d1758b5bc153_05141499',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd4feecdd9566e8bae7481b1a2ca0fe61d327f8e2' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\backend\\templates\\addons\\price_per_unit\\hooks\\products\\update_product_availability.pre.tpl',
      1 => 1656493754,
      2 => 'tygh',
    ),
  ),
...
function content_62d1758b5bc153_05141499 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\block.component.php','function'=>'smarty_block_component',),1=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\block.hook.php','function'=>'smarty_block_hook',),));
...
:</label>
                <div class="controls">
                    <input type="text" name="product_data[unit_name]" id="elm_product_unit_name" size="55" value="<?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['product_data']->value['unit_name'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
" class="input-long" />
...
:</label>
                <div class="controls">
                    <input type="text" name="product_data[units_in_product]" id="elm_product_units_in_product" size="55" value="<?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['product_data']->value['units_in_product'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
" class="input-long" />
...
:</label>
                <div class="controls">
                    <input type="text" name="product_data[show_price_per_x_units]" id="elm_product_show_price_per_x_units" size="55" value="<?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['product_data']->value['show_price_per_x_units'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
" class="input-long" />
