...
/* Smarty version 4.1.0, created on 2022-07-15 17:11:24
  from 'C:\OpenServer\domains\cscart\design\backend\templates\views\products\components\picker\picker.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62d1758c599b95_39782430',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e3d45ad7b095cda9c2c1e2d8f1fc2526f61e042b' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\backend\\templates\\views\\products\\components\\picker\\picker.tpl',
      1 => 1656493754,
      2 => 'tygh',
    ),
  ),
...
function content_62d1758c599b95_39782430 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\modifier.to_json.php','function'=>'smarty_modifier_to_json',),));
...
$_smarty_tpl->_subTemplateRender("tygh:pickers/products/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('picker_id'=>((string)$_smarty_tpl->tpl_vars['advanced_picker_id']->value),'data_id'=>"om",'no_container'=>true,'icon'=>"icon-reorder",'but_text'=>$_prefixVariable4,'show_but_text'=>false,'view_mode'=>"button",'meta'=>"object-picker__advanced-btn object-picker__advanced-btn--products ".((string)$_smarty_tpl->tpl_vars['object_picker_advanced_btn_class']->value),'segment'=>$_smarty_tpl->tpl_vars['segment']->value), 0, false);
?>
            </div>
        <?php }?>
...
echo htmlspecialchars(fn_url("products.get_products_list?".$_prefixVariable5.$_prefixVariable6), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars(smarty_modifier_to_json(array(array("id"=>0,"text"=>$_prefixVariable7))), ENT_QUOTES, 'UTF-8');?>
"
                    <?php }?>
            >
                <?php
...
if ($_smarty_tpl->tpl_vars['show_simple_product']->value) {?> object-picker__result--simple-products<?php }?>">
        <?php ob_start();
echo htmlspecialchars($_smarty_tpl->tpl_vars['result_title_pre']->value, ENT_QUOTES, 'UTF-8');
$_prefixVariable8 = ob_get_clean();
ob_start();
echo htmlspecialchars($_smarty_tpl->tpl_vars['result_title_post']->value, ENT_QUOTES, 'UTF-8');
$_prefixVariable9 = ob_get_clean();
$_smarty_tpl->_subTemplateRender("tygh:views/products/components/picker/item_extended.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('type'=>"result",'title_pre'=>$_prefixVariable8,'title_post'=>$_prefixVariable9), 0, false);
?>
    </div>
<?php echo '</script'; ?>
>
...
$_smarty_tpl->_subTemplateRender("tygh:views/products/components/picker/item_extended.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('type'=>"selection",'title_pre'=>$_prefixVariable10,'title_post'=>$_prefixVariable11), 0, true);
?>
...
$_smarty_tpl->_subTemplateRender("tygh:views/products/components/picker/item.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('type'=>"selection",'title_pre'=>$_prefixVariable12,'title_post'=>$_prefixVariable13), 0, false);
?>
        </div>
    <?php echo '</script'; ?>
>
