...
/* Smarty version 4.1.0, created on 2022-07-14 13:06:31
  from 'C:\OpenServer\domains\cscart\design\backend\templates\views\companies\components\company_field.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62cfeaa7d038e5_72838116',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '80235a67adc38a5a87948356897ca1d95ada82e4' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\backend\\templates\\views\\companies\\components\\company_field.tpl',
      1 => 1656493754,
      2 => 'tygh',
    ),
  ),
...
function content_62cfeaa7d038e5_72838116 (Smarty_Internal_Template $_smarty_tpl) {
...
" id="<?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['id']->value ?? null)===null||$tmp==='' ? "company_id" ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
...
<?php if (!$_smarty_tpl->tpl_vars['runtime']->value['simple_ultimate']) {?>
    <?php if (!$_smarty_tpl->tpl_vars['no_wrap']->value) {?>
        <div class="control-group">
            <label class="control-label <?php if ($_smarty_tpl->tpl_vars['required']->value) {?>cm-required<?php }?>" for="<?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['id']->value ?? null)===null||$tmp==='' ? "company_id" ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
