...
/* Smarty version 4.1.0, created on 2022-07-15 17:11:22
  from 'C:\OpenServer\domains\cscart\design\backend\templates\common\form_file_uploader.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62d1758ad7a269_69007388',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '070cdc359b570eef3510670f29214bcc7c60cbc0' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\backend\\templates\\common\\form_file_uploader.tpl',
      1 => 1656493754,
      2 => 'tygh',
    ),
  ),
...
function content_62d1758ad7a269_69007388 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\function.include_ext.php','function'=>'smarty_function_include_ext',),1=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\modifier.sizeof.php','function'=>'smarty_modifier_sizeof',),2=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\block.inline_script.php','function'=>'smarty_block_inline_script',),));
...
"
    data-ca-existing-pairs="<?php echo htmlspecialchars(json_encode(array_values((($tmp = $_smarty_tpl->tpl_vars['existing_pairs']->value ?? null)===null||$tmp==='' ? array() ?? null : $tmp))), ENT_QUOTES, 'UTF-8');?>
"
...
"
    ...
    data-ca-image-pair-types="<?php echo htmlspecialchars(json_encode(array_filter((($tmp = $_smarty_tpl->tpl_vars['image_pair_types']->value ?? null)===null||$tmp==='' ? array() ?? null : $tmp))), ENT_QUOTES, 'UTF-8');?>
"
                    ...
                    <div class="btn-group file-uploader__pickers-buttons" id="last_edited_items" data-ca-fileupload-picker-container>
                        <a class="btn file-uploader__pickers-buttons-select" data-ca-fileupload-picker-local>
                            <?php if ($_smarty_tpl->tpl_vars['existing_files']->value) {?>
                                <?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['upload_file_text']->value ?? null)===null||$tmp==='' ? $_smarty_tpl->__("drop_images_select_short") ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>

                            <?php } else { ?>
                                <?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['upload_file_text']->value ?? null)===null||$tmp==='' ? $_smarty_tpl->__("drop_images_select") ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
