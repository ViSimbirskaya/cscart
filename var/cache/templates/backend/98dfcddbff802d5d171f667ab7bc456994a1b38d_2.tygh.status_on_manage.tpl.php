<?php
/* Smarty version 4.1.0, created on 2022-07-25 14:50:35
  from 'C:\OpenServer\domains\cscart\design\backend\templates\views\departments\components\status_on_manage.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62de838be0e4b9_88130824',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '98dfcddbff802d5d171f667ab7bc456994a1b38d' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\backend\\templates\\views\\departments\\components\\status_on_manage.tpl',
      1 => 1658749832,
      2 => 'tygh',
    ),
  ),
...
function content_62de838be0e4b9_88130824 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\block.hook.php','function'=>'smarty_block_hook',),1=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\function.script.php','function'=>'smarty_function_script',),));
$_smarty_tpl->_assignInScope('items_status', (($tmp = $_smarty_tpl->tpl_vars['items_status']->value ?? null)===null||$tmp==='' ? (fn_get_departments($_smarty_tpl->tpl_vars['status']->value,$_smarty_tpl->tpl_vars['hidden']->value)) ?? null : $tmp));
...
<?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"departments:status_name_container"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"departments:status_name_container"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
if ($_smarty_tpl->tpl_vars['non_editable']->value || $_smarty_tpl->tpl_vars['display']->value == "text") {?>
    <span class="view-status">
        <?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"departments:status_name"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"departments:status_name"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo smarty_block_hook(array('name'=>"departments:status_name"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
"
        id="department_status_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_select">
        <?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"departments:status_name"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"departments:status_name"), null, $_smarty_tpl, $_block_repeat);
...
?>
                    <li <?php if ($_smarty_tpl->tpl_vars['status']->value == $_smarty_tpl->tpl_vars['status_id']->value) {?>class="disabled"<?php }?>>
                        <?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"departments:status_select_item"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"departments:status_select_item"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['statuses']->value[$_smarty_tpl->tpl_vars['status_id']->value]['params']['color'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8');
}?>');"
                            >
                        ...
                        <?php $_block_repeat=false;
echo smarty_block_hook(array('name'=>"departments:status_select_item"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
                    </li>
                <?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
            ...
            <?php }?>
        <?php }?>
    <!--department_status_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_select--></div>
<?php }
$_block_repeat=false;
echo smarty_block_hook(array('name'=>"departments:status_name_container"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
}
