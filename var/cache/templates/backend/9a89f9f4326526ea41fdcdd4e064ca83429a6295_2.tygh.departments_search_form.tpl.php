<?php
/* Smarty version 4.1.0, created on 2022-07-25 13:20:23
  from 'C:\OpenServer\domains\cscart\design\backend\templates\views\departments\components\departments_search_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62de6e67ce2270_41234950',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9a89f9f4326526ea41fdcdd4e064ca83429a6295' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\backend\\templates\\views\\departments\\components\\departments_search_form.tpl',
      1 => 1658744421,
      2 => 'tygh',
    ),
  ),
  ...
  array (
    ...
    'tygh:views/departments/components/advanced_search_form.tpl' => 2,
...
function content_62de6e67ce2270_41234950 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\function.array_to_fields.php','function'=>'smarty_function_array_to_fields',),1=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\block.hook.php','function'=>'smarty_block_hook',),2=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\modifier.count.php','function'=>'smarty_modifier_count',),));
\Tygh\Languages\Helper::preloadLangVars(array('admin_search_title','find_results_with','price','search_in_category','all_categories','all_categories','search_in','department_name','short_description','full_description','keywords','search_by_department_filters','search_by_department_features','error_features_too_many_variants','search_by_sku','popularity','ttc_popularity','subcategories','shipping_freight','weight','quantity','free_shipping','yes','no','status','purchased_in_orders','no_items','sort_by','list_price','name','price','sku','quantity','status','desc','asc','creation_date','updated_last','hour_or_hours'));
...
" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['department_search_form_prefix']->value, ENT_QUOTES, 'UTF-8');?>
...
" id="search_form">
<input type="hidden" name="type" value="<?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['search_type']->value ?? null)===null||$tmp==='' ? "simple" ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
" autofocus="autofocus" />
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "simple_search", null, null);?>
    <?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"departments:simple_search"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"departments:simple_search"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo smarty_block_hook(array('name'=>"departments:simple_search"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>

<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "advanced_search", null, null);
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"departments:advanced_search"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"departments:advanced_search"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
    ...
    <div class="table-wrapper">
        <table width="100%">
            <tr class="nowrap">
                <td><label for="pname" class="checkbox inline"><input type="checkbox" value="Y" <?php if ($_smarty_tpl->tpl_vars['search']->value['pname'] == "Y") {?>checked="checked"<?php }?> name="pname" id="pname" /><?php echo $_smarty_tpl->__("department_name");?>
</label></td>
...
<?php if ($_smarty_tpl->tpl_vars['filter_items']->value) {?>
    <div class="control-group">
        ...
        <?php echo $_smarty_tpl->__("search_by_department_filters");?>
</a>

        <div id="filter"<?php if (!$_COOKIE['filter']) {?> class="hidden"<?php }?>>
            <?php $_smarty_tpl->_subTemplateRender("tygh:views/departments/components/advanced_search_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('filter_features'=>$_smarty_tpl->tpl_vars['filter_items']->value,'prefix'=>"filter_",'data_name'=>"filter_variants"), 0, false);
?>
        </div>
    </div>
<?php }?>
...
<div class="group form-horizontal">
    <div class="control-group">
        ...
        <a class="search-link cm-combination nowrap open cm-save-state" id="sw_feature"><span id="on_feature" class="cm-combination cm-save-state <?php if ($_COOKIE['feature']) {?>hidden<?php }?>"><span class="icon-caret-right"></span></span><span id="off_feature" class="cm-combination cm-save-state <?php if (!$_COOKIE['feature']) {?>hidden<?php }?>"><span class="icon-caret-down"></span></span><?php echo $_smarty_tpl->__("search_by_department_features");?>
</a>

        <div id="feature"<?php if (!$_COOKIE['feature']) {?> class="hidden"<?php }?>>
            <?php $_smarty_tpl->_subTemplateRender("tygh:views/departments/components/advanced_search_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('filter_features'=>$_smarty_tpl->tpl_vars['feature_items']->value,'prefix'=>"feature_",'data_name'=>"feature_variants"), 0, true);
?>
        </div>
    </div>
</div>
...
" onfocus="this.select();" class="input-mini" />
    ...
    <?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"companies:departments_advanced_search"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"companies:departments_advanced_search"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
?>
    <?php }?>
    <?php $_block_repeat=false;
echo smarty_block_hook(array('name'=>"companies:departments_advanced_search"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
    ...
    <div class="group span6 form-horizontal">
        ...
        <div class="control-group">
            ...
            <select name="status" id="status">
                <option value="">--</option>
                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, fn_get_departments(), 'status_name', false, 'status_id');
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                        ...
                        <?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"departments:search_form"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"departments:search_form"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
$_block_repeat=false;
echo smarty_block_hook(array('name'=>"departments:search_form"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
    </div>

    <div class="group span6 form-horizontal">
                <?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"departments:search_in_orders"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"departments:search_in_orders"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
        <div class="control-group">
...
?>
        ...
        <?php $_block_repeat=false;
echo smarty_block_hook(array('name'=>"departments:search_in_orders"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
        <div class="control-group">
            ...
            <select class="select-mini" name="sort_by" id="sort_by">
                ...
                <option <?php if ($_smarty_tpl->tpl_vars['search']->value['sort_by'] == "department") {?>selected="selected"<?php }?> value="department"><?php echo $_smarty_tpl->__("name");?>
</option>
                ...
                <?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"departments:select_search"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"departments:select_search"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
                <?php $_block_repeat=false;
echo smarty_block_hook(array('name'=>"departments:select_search"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
            </select> -
...
<div class="group form-horizontal">
    <div class="control-group">
        ...
        <div class="controls">
            <?php $_smarty_tpl->_subTemplateRender("tygh:common/period_selector.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('period'=>$_smarty_tpl->tpl_vars['search']->value['period'],'form_name'=>((string)$_smarty_tpl->tpl_vars['department_search_form_prefix']->value)."search_form"), 0, false);
?>
        </div>
    </div>
</div>
