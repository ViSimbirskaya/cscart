...
/* Smarty version 4.1.0, created on 2022-07-08 12:16:38
  from 'C:\OpenServer\domains\cscart\design\backend\templates\components\bottom_panel\bottom_panel.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62c7f5f665cf25_12731053',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a2f47dc11fb8bdd102185e72220e6491984a834a' => 
    array (
...
function content_62c7f5f665cf25_12731053 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\block.hook.php','function'=>'smarty_block_hook',),1=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\modifier.enum.php','function'=>'smarty_modifier_enum',),2=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.replace.php','function'=>'smarty_modifier_replace',),3=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\function.script.php','function'=>'smarty_function_script',),4=>array('file'=>'C:\\OpenServer\\domains\\cscart\\app\\functions\\smarty_plugins\\function.set_id.php','function'=>'smarty_function_set_id',),));
...
echo htmlspecialchars(fn_url("bottom_panel.redirect?url=".((string)(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url'])))."&area=".((string)(defined('AREA') ? constant('AREA') : null))."&to_area=C".$_prefixVariable2,$_smarty_tpl->tpl_vars['redirect_area']->value), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars(fn_url("customization.disable_mode?type=live_editor&return_url=".$_prefixVariable3), ENT_QUOTES, 'UTF-8');?>
"
                    <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "theme") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable4=ob_get_clean();
echo htmlspecialchars(fn_url("customization.disable_mode?type=theme_editor&return_url=".$_prefixVariable4), ENT_QUOTES, 'UTF-8');?>
"
                    <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "build") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable5=ob_get_clean();
echo htmlspecialchars(fn_url("customization.disable_mode?type=block_manager&return_url=".$_prefixVariable5), ENT_QUOTES, 'UTF-8');?>
"
                    <?php } else { ?>
...
echo htmlspecialchars(fn_url("customization.update_mode?type=live_editor&status=enable&return_url=".$_prefixVariable6), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars(fn_url("customization.update_mode?type=theme_editor&status=enable&return_url=".$_prefixVariable7), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
...
echo htmlspecialchars(fn_url("customization.update_mode?type=block_manager&status=enable&return_url=".$_prefixVariable8), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
...
echo htmlspecialchars(fn_url("bottom_panel.redirect?url=".((string)(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url'])))."&area=".((string)(defined('AREA') ? constant('AREA') : null))."&to_area=C".$_prefixVariable9,$_smarty_tpl->tpl_vars['redirect_area']->value), ENT_QUOTES, 'UTF-8');?>
"
                class="bp-nav__item cm-no-ajax
                <?php if ((defined('ACCOUNT_TYPE') ? constant('ACCOUNT_TYPE') : null) === "customer") {?>
                    bp-nav__item--active
...
echo htmlspecialchars(fn_url("customization.disable_mode?type=live_editor&return_url=".$_prefixVariable10), ENT_QUOTES, 'UTF-8');?>
"
                    <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "theme") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable11=ob_get_clean();
echo htmlspecialchars(fn_url("customization.disable_mode?type=theme_editor&return_url=".$_prefixVariable11), ENT_QUOTES, 'UTF-8');?>
"
                    <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "build") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable12=ob_get_clean();
echo htmlspecialchars(fn_url("customization.disable_mode?type=block_manager&return_url=".$_prefixVariable12), ENT_QUOTES, 'UTF-8');?>
"
                    <?php } else { ?>
                        href="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars(fn_url("customization.update_mode?type=live_editor&status=enable&return_url=".$_prefixVariable13), ENT_QUOTES, 'UTF-8');?>
"
                        id="settings_live_editor"
                        class="cm-no-ajax bp-modes__item bp-modes__item--text
                        <?php if ($_smarty_tpl->tpl_vars['active_mode']->value === "text") {?>bp-modes__item--active<?php }?>"
...
echo htmlspecialchars(fn_url("customization.update_mode?type=theme_editor&status=enable&return_url=".$_prefixVariable14), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
                        id="settings_theme_editor"
                        class="cm-no-ajax bp-modes__item bp-modes__item--theme
                        <?php if ($_smarty_tpl->tpl_vars['active_mode']->value === "theme") {?>bp-modes__item--active<?php }?>
...
echo htmlspecialchars(fn_url("customization.update_mode?type=block_manager&status=enable&return_url=".$_prefixVariable15), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
                       id="settings_block_manager"
                       class="cm-no-ajax bp-modes__item bp-modes__item--build
                        <?php if ($_smarty_tpl->tpl_vars['active_mode']->value === "build") {?>bp-modes__item--active<?php }?>
